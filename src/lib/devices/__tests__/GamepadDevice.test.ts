...
describe("GamepadDevice", () =>
{
    ...
    {
        it.each([
            [ "amazon_luna", "XINPUT Device - Amazon Luna Controller" ],
            [ "amazon_luna", "Unknown Input Device (Vendor: 1949 Product: 0000)" ],
            ...
            [ "nintendo_wiiu", "Unknown (Vendor: 057e Product: 0337)" ],

            [ "nvidia_shield", "Nvidia Shield" ],
            [ "nvidia_shield", "Input Device (Vendor: 0955 Product: b401)" ],

            [ "playstation_4", "Wireless Controller (STANDARD GAMEPAD Vendor: 054c Product: 05c4)" ],
            [ "playstation_4", "Unknown playstation_4" ],
    ...
    it("maps axis, buttons and triggers", () =>
    {
        ...
        (source.axes[Axis.RightStickY] as any) = -0.65;
        ...
        expect(gamepad.rightJoystick.y).toBe(-0.65);
