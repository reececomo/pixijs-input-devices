...
class InputDeviceManager
{
    ...
    /** Whether touch screen is available */
    ...
    private readonly _bindUpEmitter = new EventEmitter<Record<string, NamedBindEvent>>();
   ...
   */
    ...
    /** Adds a named bind event listener. */
    public onBindUp<N extends string>(
        name: N | readonly N[],
        listener: (event: NamedBindEvent<N>) => void,
        options?: EventOptions,
    ): this
    ...
    /** Report a named bind event (from a CustomDevice). */
    public emitBindUp(e: NamedBindEvent): void
    {
        this._bindUpEmitter.emit(e.name, e);
    }
